...
- **JSON (`{filename}_v{n}.{m}_3_detail.json`):** 全ての `[Sxxx]`, `[Txxx]`, `[Lxxx]`, `[Ixxx]`, `[Oxxx]`, `[Vxxx]` および `[Fxxx]` の定義をリスト化して出力する。
- **役割分担:**
...
#### 4. 出力ファイル
- `{filename}_v{n}.{m}_3_detail.md`
- `{filename}_v{n}.{m}_3_detail.json`
...
### 詳細設計書の作成手順
  ...
  1. 対応する基本設計書（`_1_base.md` および `_2_base_confirm.md`）と同じバージョン・リビジョンであることを確認します。
